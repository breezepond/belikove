...
Private Sub Btn_Search_Click()
 Dim sqlCommand As String
    ...
    Set recordSet = DbConnection.Execute(sqlCommand)
        ...
        Pricesort.Text = recordSet.Fields("PriceSort")
        Prodate.Text = recordSet.Fields("ProDate")
        ResponseNurse.Text = recordSet.Fields("ResponseNurse")
        Groups.Text = recordSet.Fields("Groups")
        Mainjudgement.Text = recordSet.Fields("Mainjudgement")
        End If
    DbConnection.Close
End Sub
